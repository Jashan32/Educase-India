function Account() {
    return (
        <div className="w-[100vw] flex justify-center h-[100dvh] items-center">
            <div className="xl:h-[90%] h-[100dvh] border border-gray-200 flex flex-col">

                <div className="shadow-md z-10 shadow-b-black font-semibold h-[68px] flex items-center text-[18px] text-[#1D2226] pl-[20px]">
                    Account Settings
                </div>

                <div className="max-w-[100vw] w-[375px] h-full bg-[#F7F8F9] flex flex-col justify-start pt-[30px]">
                    ...
                    <div className="px-[20px] text-[#1D2226]/60 mt-[30px] pb-[10px]">
